////////////////////////////////////////////////////////////////////
//
// $Id: vbo_glfw_eigen.cxx 2021/06/13 14:55:10 kanai Exp $
//
...
int main( int argc, char **argv )
{
  ...
  offrio_input.inputFromFile( argv[1] );
  meshR.normalize();
  ...
  Eigen::Vector3f p( .0f, .0f, 2.5f );
  Eigen::Vector3f l( .0f, .0f, .0f );
  pane.setViewPoint( p );
  pane.setLookPoint( l );
